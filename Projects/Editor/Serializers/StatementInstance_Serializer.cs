...
namespace VisualScriptTool.Editor.Serializers
{
	class StatementInstance_Serializer : Serializer
	{
		...
		public override T Deserialize<T>(ISerializeData Data)
		{
			...
			ReferenceTable references = new ReferenceTable();
			return DeserializeInternal<T>(Data, references);
		}
		...
		public override T DeserializeInternal<T>(ISerializeData Data, ReferenceTable References)
		{
			if (Data is ISerializeArray)
			{
				...
				for (uint i = 0; i < Array.Count; ++i)
				{
					...
					StatementInstanceArray[i] = GetSerializer(targetType).DeserializeInternal<VisualScriptTool.Editor.StatementInstance>(Get<ISerializeObject>(arrayObj, 2), References); 
				}
			...
			else
			{
				...
				if (StatementObject != null)
				{
					...
					StatementInstance.Statement = StatementSerializer.DeserializeInternal<VisualScriptTool.Language.Statements.Statement>(Get<ISerializeObject>(StatementObjectValue, 2), References);
				}
				else
				...
				if (PositionObject != null)
				{
					...
					StatementInstance.Position = PositionSerializer.DeserializeInternal<System.Drawing.PointF>(Get<ISerializeObject>(PositionObjectValue, 2), References);
				}
				// HeaderSize
				...
				if (HeaderSizeObject != null)
				{
					...
					StatementInstance.HeaderSize = HeaderSizeSerializer.DeserializeInternal<System.Drawing.SizeF>(Get<ISerializeObject>(HeaderSizeObjectValue, 2), References);
				}
				// BodySize
				...
				if (BodySizeObject != null)
				{
					...
					StatementInstance.BodySize = BodySizeSerializer.DeserializeInternal<System.Drawing.SizeF>(Get<ISerializeObject>(BodySizeObjectValue, 2), References);
				}
