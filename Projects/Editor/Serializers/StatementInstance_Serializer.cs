		...
		public override void Serialize(ISerializeData Data, object Instance)
		{
			...
			else
			{
				...
				else
				{
					...
					GetSerializer(StatementType).Serialize(AddObject(StatementObject, 1), StatementInstance.Statement);
				}
				// Position
		...
		public override T Deserialize<T>(ISerializeData Data)
		{
			...
			else
			{
				...
				if (StatementObject != null)
				{
					...
					StatementInstance.Statement = StatementSerializer.Deserialize<VisualScriptTool.Language.Statements.Statement>(Get<ISerializeObject>(StatementObjectValue, 1));
				}
				else
