		...
		public override void Serialize(ISerializeData Data, object Instance)
		{
			...
			else
			{
				...
				else
				{
					...
					GetSerializer(StatementType).Serialize(AddObject(StatementObject, 1), IfStatementInstance.Statement);
				}
				// Position
		...
		public override T Deserialize<T>(ISerializeData Data)
		{
			...
			else
			{
				...
				if (StatementObject != null)
				{
					...
					IfStatementInstance.Statement = StatementSerializer.Deserialize<VisualScriptTool.Language.Statements.Statement>(Get<ISerializeObject>(StatementObjectValue, 1));
				}
				else
