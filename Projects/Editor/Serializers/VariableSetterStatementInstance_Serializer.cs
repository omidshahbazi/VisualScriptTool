...
{
	class VariableSetterStatementInstance_Serializer : Serializer
	{
		public override System.Type Type
		{
			get { return typeof(VisualScriptTool.Editor.Language.VariableSetterStatementInstance); }
		}

		public override object CreateInstance()
		{
			return new VisualScriptTool.Editor.Language.VariableSetterStatementInstance(null);
		}
		...
		public override void SerializeInternal(ISerializeData Data, object Instance, System.Type InstanceType, ReferenceTable References)
		{
			if (InstanceType.IsArrayOrList())
			{
				...
				VisualScriptTool.Editor.Language.VariableSetterStatementInstance[] VariableSetterStatementInstanceArray = null;
				if (InstanceType.IsArray())
					VariableSetterStatementInstanceArray = (VisualScriptTool.Editor.Language.VariableSetterStatementInstance[])Instance;
				else
					VariableSetterStatementInstanceArray = ((System.Collections.Generic.List<VisualScriptTool.Editor.Language.VariableSetterStatementInstance>)Instance).ToArray();
				for (int i = 0; i < VariableSetterStatementInstanceArray.Length; ++i)
				{
					VisualScriptTool.Editor.Language.VariableSetterStatementInstance element = VariableSetterStatementInstanceArray[i];
					if (element == null)
						Add(Array, null);
					else
					{
			...
			else
			{
				...
				VisualScriptTool.Editor.Language.VariableSetterStatementInstance VariableSetterStatementInstance = (VisualScriptTool.Editor.Language.VariableSetterStatementInstance)Instance;
				// Statement
				if (VariableSetterStatementInstance.Statement == null)
					Set(Object, 3, null);
				else
				{
					ISerializeObject StatementObject = AddObject(Object, 3); 
					string guid = string.Empty;
					if (References.ContainsKey(VariableSetterStatementInstance.Statement))
						guid = References[VariableSetterStatementInstance.Statement];
					else
					{
						guid = System.Guid.NewGuid().ToString();
						References[VariableSetterStatementInstance.Statement] = guid;
						System.Type StatementType = VariableSetterStatementInstance.Statement.GetType();
						Set(StatementObject, 1, StatementType.AssemblyQualifiedName);
						GetSerializer(StatementType).SerializeInternal(AddObject(StatementObject, 2), VariableSetterStatementInstance.Statement, StatementType, References);
					}
		...
		public override T DeserializeInternal<T>(ISerializeData Data, GUIDTable References, ResolverList ResolverList)
		{
			...
			{
				ISerializeArray Array = (ISerializeArray)Data; 
				VisualScriptTool.Editor.Language.VariableSetterStatementInstance[] VariableSetterStatementInstanceArray = (VisualScriptTool.Editor.Language.VariableSetterStatementInstance[])System.Array.CreateInstance(Type, Array.Count);
				for (uint i = 0; i < Array.Count; ++i)
				{
					...
					if (arrayObj == null)
					{
						VariableSetterStatementInstanceArray[i] = null;
						continue;
					}
					VariableSetterStatementInstanceArray[i] = GetSerializer(targetType).DeserializeInternal<VisualScriptTool.Editor.Language.VariableSetterStatementInstance>(Get<ISerializeObject>(arrayObj, 2), References, ResolverList); 
				}
				returnValue = (T)(object)VariableSetterStatementInstanceArray;
			}
			else
			{
				ISerializeObject Object = (ISerializeObject)Data; 
				VisualScriptTool.Editor.Language.VariableSetterStatementInstance VariableSetterStatementInstance = (VisualScriptTool.Editor.Language.VariableSetterStatementInstance)CreateInstance();
				// Statement
				...
				if (StatementObject != null)
				{
					...
					if (Contains(StatementObjectValue, 1))
					{
						...
						VariableSetterStatementInstance.Statement = StatementSerializer.DeserializeInternal<VisualScriptTool.Language.Statements.Statement>(Get<ISerializeObject>(StatementObjectValue, 2), References, ResolverList);
						References[guid] = VariableSetterStatementInstance.Statement;
					}
					else
						ResolverList.Add(new ReferenceResolver(guid, VariableSetterStatementInstance, VariableSetterStatementInstance.GetType().GetProperty("Statement", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic)));
				}
				else
					VariableSetterStatementInstance.Statement = null;
				// Position
				...
				if (PositionObject != null)
				{
					...
					VariableSetterStatementInstance.Position = PositionSerializer.DeserializeInternal<System.Drawing.PointF>(Get<ISerializeObject>(PositionObjectValue, 2), References, ResolverList);
				}
				// HeaderSize
				...
				if (HeaderSizeObject != null)
				{
					...
					VariableSetterStatementInstance.HeaderSize = HeaderSizeSerializer.DeserializeInternal<System.Drawing.SizeF>(Get<ISerializeObject>(HeaderSizeObjectValue, 2), References, ResolverList);
				}
				// BodySize
				...
				if (BodySizeObject != null)
				{
					...
					VariableSetterStatementInstance.BodySize = BodySizeSerializer.DeserializeInternal<System.Drawing.SizeF>(Get<ISerializeObject>(BodySizeObjectValue, 2), References, ResolverList);
				}
